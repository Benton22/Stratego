...
spawnerRed.append(PieceSpawner((11*2) * width/24 - width/22, height - 3 * height/48, 30, "Stratego\\Pieces\\Bomb.png", "B", True))
...
def gameLogic(screen, mousePressed):
    ...
    if mousePressed:
        if pieceSelected == False:
            ...
            if xIndex < 12 and yIndex < 12 and grid [xIndex -1 ][yIndex -1] == 0:
